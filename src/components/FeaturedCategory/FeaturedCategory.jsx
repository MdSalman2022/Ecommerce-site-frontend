...
const FeaturedCategory = () => {
    ...
    return (
        <div className='py-5 lg:py-20 px-2 mx-2 md:mx-0'>
            ...
            <div className="md:drop-shadow-xl container mx-auto flex flex-col items-center justify-center lg:grid lg:grid-cols-4 gap-3 lg:gap-14 bg-accent rounded-3xl md:pr-3 py-5 md:py-0">
                <div className="bg-white shadow lg:col-span-1 w-72 md:w-80 lg:w-96 image-full  h-96 lg:h-[600px] rounded-3xl md:rounded-l-3xl flex justify-center items-center overflow-hidden relative border-b-2 md:border-b-0 lg:border-r-2">
                ...
                <div className="lg:col-span-3 px-5 md:p-5 lg:p-0 col-span-3 grid gap-5 lg:gap-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center place-content-center">
                    {
