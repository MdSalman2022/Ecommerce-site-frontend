        ...
        <div>
            <div className="grid lg:grid-cols-2 mx-auto container gap-5"> 
                <div className='h-full bg-white border flex justify-center py-20 rounded-lg relative group'> 
                    ...
                    <div className="absolute bg-neutral h-40 w-full bottom-0 flex flex-col  justify-between  text-white md:justify-center md:items-center rounded-b-lg p-5 md:p-0">
                        ...
                        <div className="primary-btn md:mt-5">Shop Now</div>
                    </div>
                </div>
