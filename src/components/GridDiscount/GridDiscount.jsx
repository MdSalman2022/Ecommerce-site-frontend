    ...
    return (
        <div>
            <div className="grid lg:grid-cols-2 mx-auto container gap-5"> 
                <div className='h-full bg-base-100 dark:bg-accent border flex justify-center py-20 rounded-lg relative group'> 
                    ...
                    <div className="absolute bg-neutral dark:bg-neutral dark:bg-opacity-90  h-40 w-full bottom-0 flex flex-col  justify-between  text-base-100 md:justify-center md:items-center rounded-b-lg p-5 md:p-0">
                ...
                <div className='h-full bg-base-100 dark:bg-accent border flex justify-center py-10 rounded-lg relative group'>
                    <div className=' transition-all duration-300'>
                    ...
                    <div className="absolute bg-accent dark:bg-neutral dark:bg-opacity-70 h-48 md:h-40 w-full bottom-0 flex flex-col justify-between text-neutral md:justify-center md:items-center border-t rounded-b-lg p-5 md:p-0">
                        <div>
