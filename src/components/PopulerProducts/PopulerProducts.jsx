                ...
                <div className="flex flex-col md:flex-row justify-between gap-2 py-5">
                        ...
                        <div className='flex justify-center items-center gap-5'>
                            <div className='flex flex-wrap gap-3'>
                                <button onClick={() => handleType(0)} className={`btn rounded-3xl btn-primary transition-all duration-300 border ${type !== '' ? 'btn-outline' : 'text-white'}`}>All</button>
                                <button onClick={() => handleType(1)} className={`btn rounded-3xl transition-all duration-300 border btn-primary ${type !== 'smartphone' ? 'btn-outline' : 'text-white'}`}>Smartphones</button>
                                ...
                                <button onClick={() => handleType(3)} className={`btn rounded-3xl transition-all duration-300 border btn-primary ${type !== 'components' ? 'btn-outline' : 'text-white'}`}>Desktop components</button>
                                <button onClick={() => handleType(4)} className={`btn rounded-3xl transition-all duration-300 border btn-primary ${type !== 'accessories' ? 'btn-outline' : 'text-white'}`}>Accessories</button>
                                <button onClick={() => handleType(5)} className={`btn rounded-3xl transition-all duration-300 border btn-primary ${type !== 'camera' ? 'btn-outline' : 'text-white'}`}>Camera</button>
                            </div>
                            <div className='hidden md:flex lg:justify-center justify-between gap-3 w-full md:w-32 text-white '>
