    ...
    <div className=" py-5 md:py-20">
      <div className="container mx-auto  grid grid-cols-1 lg:grid-cols-3">
        <div className="flex flex-col justify-center gap-3">
          <h3 className="text-xl font-bold text-secondary md:text-4xl">
            Back In Store this week
          </h3>
          <p className="w-96 text-neutral dark:text-accent">
            Finally these fast selling products are back in stock. What's in it
            for you? Be quick or be...
          </p>
          <Link
            onClick={scrolltop}
            to="/products"
          ...
          >
            View all products <FaAngleRight />
          </Link>
        </div>
