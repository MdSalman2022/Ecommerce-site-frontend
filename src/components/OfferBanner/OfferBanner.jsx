            ...
            <div className='container mx-auto md:border rounded-none md:rounded-2xl '>
                ...
                <div className="card  bg-base-100 image-full md:h-[500px]">
                    ...
                    <div className="card-body flex-col justify-center items-center ">
                        <div className="text-xl md:text-4xl text-center flex  text-base-100 gap-2">Get upto <span className='font-bold text-primary '>50%</span> Off On All </div>
                        <span className='text-xl md:text-4xl text-primary font-bold'>Accessories</span>
