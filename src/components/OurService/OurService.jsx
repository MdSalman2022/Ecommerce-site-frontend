        ...
        <div className='w-full lg:max-w-screen overflow-x-hidden'>
            <div className='bg-primary h-full w-full md:h-40 flex items-center'>
                <div className="container-fluid mx-auto p-5 md:p-0">
                    <div className="flex flex-col md:flex-row md:justify-between gap-5 lg:gap-20 md:items-center text-white">
                        <div className='flex text-center flex-col md:flex-row items-center gap-3'>
                            <p className='text-xl md:text-2xl lg:text-5xl border rounded-full p-2 bg-white text-primary'><TbTruckDelivery /></p>
                        ...
                        <div className='flex text-center md:text-left flex-col md:flex-row  items-center gap-3'>
                            <p className='text-xl md:text-2xl lg:text-5xl border rounded-full p-2 bg-white text-primary'><GiReturnArrow /></p>
                            <div className='flex flex-col'>
                        ...
                        <div className='flex text-center md:text-left flex-col md:flex-row  items-center gap-3'>
                            <p className='text-xl md:text-2xl lg:text-5xl border rounded-full p-2 bg-white text-primary'><MdSecurity /></p>
                            <div className='flex flex-col'>
                        ...
                        <div className='flex text-center md:text-left flex-col md:flex-row  items-center gap-3'>
                            <p className='text-xl md:text-2xl lg:text-5xl border rounded-full p-2 bg-white text-primary'><BiPhoneCall /></p>
                            <div className='flex flex-col'>
