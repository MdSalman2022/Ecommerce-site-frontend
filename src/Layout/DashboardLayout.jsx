...
function DashboardLayout() {
    ...
    return (
        <div className={`bg-accent h-full select-none grid ${isOpen ? 'grid-cols-8' : 'grid-cols-12'}`}>
            <aside className={`col-span-1 transition-colors duration-300 h-full bg-base-100 flex flex-col items-stretch py-10 gap-y-10 items-start pl-6 ${isOpen ? 'w-52 ' : 'w-24'}`}>
