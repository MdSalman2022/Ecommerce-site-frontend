...
import { Shield, ShieldCheck, CheckCircle, XCircle, Loader2, Mail } from 'lucide-react';
...
export default function AcceptInvitationPage({ params }: { params: Promise<{ token: string }> }) {
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        You are now a <span className="font-semibold capitalize">{invitation?.role}</span>.
    ...
    if (!user && invitation) {
        const signupUrl = `/register?invite=${token}&email=${encodeURIComponent(invitation.email)}`;
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600 mt-2">
                            <span className="font-semibold">{invitation.invitedBy}</span> has invited you to join BestDeal
                        </p>
                    </div>
