  ...
  return (
    <div className="min-h-screen py-10 bg-background">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-foreground mb-10">Order History</h2>
        ...
        {filteredOrders.length > 0 ? (
            ...
            {filteredOrders.map((order: any) => (
              <div key={order._id} className="border border-border rounded-xl overflow-hidden">
                ...
                <div className="flex justify-between items-center p-5 bg-accent/30">
                  <div>
                    <p className="font-bold text-foreground">Order #{order._id}</p>
                ...
                <div className="divide-y divide-border">
                  {order.items?.map((product: any, idx: number) => (
                    ...
                    >
                      ...
                      <p className="text-foreground font-medium line-clamp-2">{product.name}</p>
          ...
          <div className="text-center py-20">
            <p className="text-2xl font-bold text-foreground mb-6">No orders found</p>
            <Link href="/">
