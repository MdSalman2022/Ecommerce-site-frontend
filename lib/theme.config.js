/**
 * ============================================================================
 * BESTDEAL THEME CONFIGURATION
 * ============================================================================
 * 
 * This is the SINGLE SOURCE OF TRUTH for all colors in the application.
 * Edit this file to change the entire color scheme of the website.
 * 
 * Color Palette: Royal Blue Theme
 * - Primary: Royal Blue (#2563EB) - Trust, reliability, bold
 * - Secondary: Lighter blue for hover/accents
...
const theme = {
  // ============================================
  // PRIMARY PALETTE - Change this to change the entire theme
  // ============================================
  primary: {
  ...
  // ============================================
  // COMPLEMENTARY COLORS (auto-sync with primary)
  // ============================================
  secondary: {
    50:  '#F8FAFC',
    100: '#F1F5F9',
